...
public class MedicalStoreListFragment extends Fragment {



    private FragmentMedicalStoreListBinding mBinding;
    ...
    private void btnListener() {
        ...
        mBinding.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavDirections navDirections= MedicalStoreListFragmentDirections.actionMedicalStoreListFragmentToAddMedicalStoreFragment();
    ...
    private void setUpRecyclerView() {
        ...
        mBinding.medicalStoreListRecyclerview.setLayoutManager(new LinearLayoutManager(requireContext()));
        adapter = new SupplierRecyclerViewAdapter(this);
        adapter.setDestinationID(4);
        mBinding.medicalStoreListRecyclerview.setAdapter(adapter);
    ...
    private void getSupplier() {
        ...
        Call<List<GetSupplierModel>> call = ApiClient.getInstance().getApi().getSupplier("Dr",0,regionId);
