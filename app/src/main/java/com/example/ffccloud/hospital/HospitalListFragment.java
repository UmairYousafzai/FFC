...
import com.example.ffccloud.databinding.FragmentHospitalListBinding;
...
public class HospitalListFragment extends Fragment {
    ...
    private FragmentHospitalListBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = FragmentHospitalListBinding.inflate(inflater,container,false);
    ...
    private void btnListener() {
        ...
        mBinding.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavDirections navDirections= HospitalListFragmentDirections.actionHospitalListFragmentToAddHospitalFragment();
    ...
    private void setUpRecyclerView() {
        ...
        mBinding.hospitalListRecyclerview.setLayoutManager(new LinearLayoutManager(requireContext()));
        adapter = new SupplierRecyclerViewAdapter(this);
        adapter.setDestinationID(3);
        mBinding.hospitalListRecyclerview.setAdapter(adapter);
    ...
    private void getSupplier() {
        ...
        Call<List<GetSupplierModel>> call = ApiClient.getInstance().getApi().getSupplier("H",userID,regionId,0);
