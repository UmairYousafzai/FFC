package com.example.myapplication.PrivateTravel;
...
public class PrivateTravelFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferenceHelper.getInstance(getContext()).setActivity("Private Travel");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_private_travel, container, false);
        init(root);
