package com.example.myapplication.Office;
...
public class OfficeFragment extends Fragment {
    LinearLayout local_target, local_privatetravel, private_travel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferenceHelper.getInstance(getContext()).setActivity("Office");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        private_travel.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.R)
            @Override
            public void onClick(View v) {
                Route route = new Route();
    ...
    private void init(View root) {
        ...
        private_travel = root.findViewById(R.id.private_travel);
    }
}